          ...
          <ScrollView keyboardShouldPersistTaps="handled">
            <KeyboardAvoidingView
              ...
              <View className="p-3 flex flex-row">
                <View className="basis-1/6 p-1">
                  <TouchableOpacity>
                    <Icon name="align-justify" size={25} color="white"/>
                  </TouchableOpacity>
                </View>
                <Text className="text-white1 text-4xl basis-4/6 text-center font-monbaiti">Dashboard</Text>
              </View>
              ...
              <TouchableOpacity
               onPress={()=> navigation.navigate('Projects',{projectID:'asd'}) }
              >
